...
export default () => {
  return (
    <div>
      <div className="p-5 text-center text-white" stylex="background-color: #05585C; user-select: none">
      ...
      <div className="p-5 text-secondary" stylex="background-color: #252525; user-select: none">
        <div className="container">
          <div className="row">
            <div className="col">
      ...
      <div className="p-5 text-secondary text-center" stylex="background-color: #1C1C1C; user-select: none">
